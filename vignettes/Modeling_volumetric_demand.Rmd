...
The `echoice2` package is available from [CRAN](https://cran.r-project.org/web/packages/echoice2) and [GitHub](https://github.com/ninohardt/echoice2).
