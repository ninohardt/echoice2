...
integration in R is facilitated by [Rcpp](https://www.rcpp.org).
...
-   \`Conjunctive Screening in Models of Multiple Discreteness’ is going
    ...
    Check out this
    [example](https://github.com/ninohardt/echoice2/blob/main/man/html/echoice2_pizza.html)
    (3/22/22)
...
-   Version
    [**0.20**](https://github.com/ninohardt/echoice2/releases/tag/v0.16):
...
-   If you are using Windows, install
    \[Rtools\](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html) first.
